    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-2 gap-16 border-b w-full mt-8">
            <button
              className={cls(
                "pb-4 font-medium border-b-2",
                method === "email"
                  ? "text-orange-400 font-medium  border-orange-400"
        ...
        <form className="flex flex-col mt-8">
          ...
          <button className="mt-5 bg-orange-500 hover:bg-orange-600 text-white px-3 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 gap-3 mt-2">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-500 rounded-md shadow-sm bg-white font-medium text-gray-500 hover:bg-gray-50">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"

    ...
    <Layout title="Community" hasTabBar>
      <div className=" divide-y-2">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <div
            key={i}
            className="flex cursor-pointer flex-col items-start px-4 py-2.5"
          >
            ...
            <div className="flex space-x-5 mt-3 text-gray-700 border-t pt-2 w-full">
        ...
        <button className="fixed bottom-24 right-5 bg-orange-400 rounded-full text-white p-4 shadow-xl hover:bg-orange-500 transition-colors">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"

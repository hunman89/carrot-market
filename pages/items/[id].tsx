      ...
      <div>
        ...
        <div className="mt-10">
          ...
          <div className="flex items-center justify-between space-x-2">
            <button className="flex-1 py-2 font-medium bg-orange-500 text-white py3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 hover:bg-orange-600">
              Talk to seller
            </button>
